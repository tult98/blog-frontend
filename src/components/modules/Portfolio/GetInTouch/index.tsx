...
const GetInTouch = ({ isInView }: { isInView: boolean }) => {
  ...
  return (
    ...
    >
      ...
      <h1 className="mb-3 text-5xl font-semibold capitalize text-slate-lightest">Get in touch</h1>
      ...
      <a href="mailto:lethanhtu1551998@gmail.com" className="mt-12 capitalize styled-btn">
        Say hello
      </a>
    </section>
  )
