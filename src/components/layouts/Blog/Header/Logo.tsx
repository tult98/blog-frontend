...
const Logo = () => {
  return (
    <Link href="/">
      <div className="text-primary text-[24px] font-medium flex flex-row">
        <span>Tu</span>
        <span className="inline-block relative w-[18px]">
          <svg width="14" height="12" viewBox="0 0 14 12" fill="none" className="absolute left-0.5 top-[1px]">
            <path
          ...
          <svg width="9" height="10" viewBox="0 0 9 10" fill="none" className="absolute left-1.5 bottom-0.5">
            <path
